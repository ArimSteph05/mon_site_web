...
DDEESSCCRRIIPPTTIIOONN
       ...
       it, by setting up _h_o_o_k_s there. See documentation for ggiitt--rreecceeiivvee--ppaacckk(1).

       When the command line does not specify where to push with the <<rreeppoossiittoorryy>>
       argument, bbrraanncchh..**..rreemmoottee configuration for the current branch is consulted to
       determine where to push. If the configuration is missing, it defaults to
       _o_r_i_g_i_n.

       When the command line does not specify what to push with <<rreeffssppeecc>>...... arguments
       or ----aallll, ----mmiirrrroorr, ----ttaaggss options, the command finds the default <<rreeffssppeecc>> by
       consulting rreemmoottee..**..ppuusshh configuration, and if it is not found, honors
       ppuusshh..ddeeffaauulltt configuration to decide what to push (See ggiitt--ccoonnffiigg(1) for the
       meaning of ppuusshh..ddeeffaauulltt).

       When neither the command-line nor the configuration specify what to push, the
       default behavior is used, which corresponds to the ssiimmppllee value for
...
OOPPTTIIOONNSS
       <repository>
           ...
           parameter can be either a URL (see the section GIT URLS below) or the name
       ...
       <refspec>...
           ...
           can be any arbitrary "SHA-1 expression", such as mmaasstteerr~~44 or HHEEAADD (see
           ...
           ggiitt ppuusshh [[<<rreeppoossiittoorryy>>]] without any <<rreeffssppeecc>> argument is set to update
           some ref at the destination with <<ssrrcc>> with rreemmoottee..<<rreeppoossiittoorryy>>..ppuusshh
           configuration variable, ::<<ddsstt>> part can be omitted—such a push will update
           a ref that <<ssrrcc>> normally updates without any <<rreeffssppeecc>> on the command
           line. Otherwise, missing ::<<ddsstt>> means to update the same ref as the <<ssrrcc>>.

           If <dst> doesn’t start with rreeffss// (e.g.  rreeffss//hheeaaddss//mmaasstteerr) we will try to
           infer where in rreeffss//** on the destination <repository> it belongs based on
           ...
           •   Other ambiguity resolutions might be added in the future, but for now
               ...
               and depending on the aaddvviiccee..ppuusshhUUnnqquuaalliiffiieeddRReeffnnaammee configuration (see
               ggiitt--ccoonnffiigg(1)) suggest what refs/ namespace you may have wanted to push
               to.
           ...
           The rreeffss//hheeaaddss//** namespace will only accept commit objects, and updates
           only if they can be fast-forwarded.

           The rreeffss//ttaaggss//** namespace will accept any kind of object (as commits, trees
           and blobs can be tagged), and any updates to them will be rejected.

           It’s possible to push any type of object to any namespace outside of
           rreeffss//{{ttaaggss,,hheeaaddss}}//**. In the case of tags and commits, these will be treated
           as if they were the commits inside rreeffss//hheeaaddss//** for the purposes of whether
           ...
           the commit that existing tag object points to, or a new tag object which an
           existing commit points to.

           Tree and blob objects outside of rreeffss//{{ttaaggss,,hheeaaddss}}//** will be treated the
           same way as if they were inside rreeffss//ttaaggss//**, any update of them will be
           rejected.
           ...
           ----ffoorrccee command line option). The only exception to this is that no amount
           of forcing will make the rreeffss//hheeaaddss//** namespace accept a non-commit object.
           ...
           refspec (or ----ffoorrccee), except when forbidden by configuration or hooks. See
           rreecceeiivvee..ddeennyyDDeelleetteess in ggiitt--ccoonnffiigg(1) and pprree--rreecceeiivvee and uuppddaattee in
           ggiitthhooookkss(5).

           The special refspec :: (or ++:: to allow non-fast-forward updates) directs Git
           to push "matching" branches: for every branch that exists on the local
       ...
       --prune
           ...
           remote branch ttmmpp will be removed if a local branch with the same name
           doesn’t exist any more. This also respects refspecs, e.g.  ggiitt ppuusshh ----pprruunnee
           rreemmoottee rreeffss//hheeaaddss//**::rreeffss//ttmmpp//** would make sure that remote rreeffss//ttmmpp//ffoooo
           will be removed if rreeffss//hheeaaddss//ffoooo doesn’t exist.

       --mirror
           Instead of naming each ref to push, specifies that all refs under rreeffss//
           (which includes but is not limited to rreeffss//hheeaaddss//, rreeffss//rreemmootteess//, and
           rreeffss//ttaaggss//) be mirrored to the remote repository. Newly created local refs
           will be pushed to the remote end, locally updated refs will be force
           updated on the remote end, and deleted refs will be removed from the remote
           end. This is the default if the configuration option rreemmoottee..<<rreemmoottee>>..mmiirrrroorr
           is set.
       ...
       --tags
           All refs under rreeffss//ttaaggss are pushed, in addition to refspecs explicitly
           listed on the command line.

       --follow-tags
           Push all the refs that would be pushed without this option, and also push
           annotated tags in rreeffss//ttaaggss that are missing from the remote but are
           pointing at commit-ish that are reachable from the refs being pushed. This
           can also be specified with configuration variable ppuusshh..ffoolllloowwTTaaggss. For more
           information, see ppuusshh..ffoolllloowwTTaaggss in ggiitt--ccoonnffiigg(1).

       --[no-]signed, --signed=(true|false|if-asked)
           GPG-sign the push request to update refs on the receiving side, to allow it
           to be checked by the hooks and/or be logged. If ffaallssee or ----nnoo--ssiiggnneedd, no
           signing will be attempted. If ttrruuee or ----ssiiggnneedd, the push will fail if the
           server does not support signed pushes. If set to iiff--aasskkeedd, sign if and only
           if the server supports signed pushes. The push will also fail if the actual
           call to ggppgg ----ssiiggnn fails. See ggiitt--rreecceeiivvee--ppaacckk(1) for the details on the
           receiving end.
       ...
       -o <option>, --push-option=<option>
           ...
           contain a NUL or LF character. When multiple ----ppuusshh--ooppttiioonn==<<ooppttiioonn>> are
           given, they are all sent to the other side in the order listed on the
           command line. When no ----ppuusshh--ooppttiioonn==<<ooppttiioonn>> is given from the command
           line, the values of configuration variable ppuusshh..ppuusshhOOppttiioonn are used
           instead.

       --receive-pack=<git-receive-pack>, --exec=<git-receive-pack>
           Path to the _g_i_t_-_r_e_c_e_i_v_e_-_p_a_c_k program on the remote end. Sometimes useful
       ...
       --force-with-lease=<refname>:<expect>
           ...
           branch at the remote may advance with their commit, and blindly pushing
           with ----ffoorrccee will lose their work.
           ...
           ----ffoorrccee--wwiitthh--lleeaassee alone, without specifying the details, will protect all
           ...
           ----ffoorrccee--wwiitthh--lleeaassee==<<rreeffnnaammee>>, without specifying the expected value, will
           ...
           ----ffoorrccee--wwiitthh--lleeaassee==<<rreeffnnaammee>>::<<eexxppeecctt>> will protect the named ref (alone),
           if it is going to be updated, by requiring its current value to be the same
           as the specified value <<eexxppeecctt>> (which is allowed to be different from the
           remote-tracking branch we have for the refname, or we do not even have to
           have such a remote-tracking branch when this form is used). If <<eexxppeecctt>> is
           ...
           i.e. as ----ffoorrccee--wwiitthh--lleeaassee or ----ffoorrccee--wwiitthh--lleeaassee==<<rreeffnnaammee>> interacts very
           badly with anything that implicitly runs ggiitt ffeettcchh on the remote to be
           pushed to in the background, e.g.  ggiitt ffeettcchh oorriiggiinn on your repository in a
           cronjob.

           The protection it offers over ----ffoorrccee is ensuring that subsequent changes
           your work wasn’t based on aren’t clobbered, but this is trivially defeated
           if some background process is updating refs in the background. We don’t
           have anything except the remote tracking info to go by as a heuristic for
           refs you’re expected to have seen & are willing to clobber.

           If your editor or some other system is running ggiitt ffeettcchh in the background
           ...
           Will fail unless you manually run ggiitt ffeettcchh oorriiggiinn--ppuusshh. This method is of
           course entirely defeated by something that runs ggiitt ffeettcchh ----aallll, in that
           ...
           I.e. create a bbaassee tag for versions of the upstream code that you’ve seen
           and are willing to overwrite, then rewrite history, and finally force push
           changes to mmaasstteerr if the remote version is still at bbaassee, regardless of
           what your local rreemmootteess//oorriiggiinn//mmaasstteerr has been updated to in the
           background.

           Alternatively, specifying ----ffoorrccee--iiff--iinncclluuddeess as an ancillary option along
           with ----ffoorrccee--wwiitthh--lleeaassee[[==<<rreeffnnaammee>>]] (i.e., without saying what exact commit
           the ref on the remote side must be pointing at, or which refs on the remote
           side are being protected) at the time of "push" will verify if updates from
       ...
       -f, --force
           ...
           of the local ref used to overwrite it. Also, when ----ffoorrccee--wwiitthh--lleeaassee option
           is used, the command refuses to update a remote ref whose current value
           ...
           Note that ----ffoorrccee applies to all the refs that are pushed, hence using it
           with ppuusshh..ddeeffaauulltt set to mmaattcchhiinngg or with multiple push destinations
           configured with rreemmoottee..**..ppuusshh may overwrite refs other than the current
           ...
           refspec to push (e.g ggiitt ppuusshh oorriiggiinn ++mmaasstteerr to force a push to the mmaasstteerr
       ...
       --[no-]force-if-includes
           ...
           in it for a rewrite. The check ensures that any updates from the remote
           have been incorporated locally by rejecting the forced update if that is
           not the case.

           If the option is passed without specifying ----ffoorrccee--wwiitthh--lleeaassee, or specified
           along with ----ffoorrccee--wwiitthh--lleeaassee==<<rreeffnnaammee>>::<<eexxppeecctt>>, it is a "no-op".
       ...
       -u, --set-upstream
           ...
           (tracking) reference, used by argument-less ggiitt--ppuullll(1) and other commands.
           For more information, see bbrraanncchh..<<nnaammee>>..mmeerrggee in ggiitt--ccoonnffiigg(1).

       --[no-]thin
           These options are passed to ggiitt--sseenndd--ppaacckk(1). A thin transfer significantly
           reduces the amount of sent data when the sender and receiver share many of
           the same objects in common. The default is ----tthhiinn.
       ...
       --no-recurse-submodules, --recurse-submodules=check|on-demand|only|no
           ...
           pushed are available on a remote-tracking branch. If _c_h_e_c_k is used Git will
           ...
           commits are missing the push will be aborted and exit with non-zero status.
           If _o_n_-_d_e_m_a_n_d is used all submodules that changed in the revisions to be
           pushed will be pushed. If on-demand was not able to push all necessary
           revisions it will also be aborted and exit with non-zero status. If _o_n_l_y is
           used all submodules will be recursively pushed while the superproject is
           left unpushed. A value of _n_o or using ----nnoo--rreeccuurrssee--ssuubbmmoodduulleess can be used
           to override the push.recurseSubmodules configuration variable when no
           submodule recursion is required.

       --[no-]verify
           Toggle the pre-push hook (see ggiitthhooookkss(5)). The default is --verify, giving
           the hook a chance to prevent the push. With --no-verify, the hook is
           bypassed completely.
...
GGIITT UURRLLSS
       ...
       local path ffoooo::bbaarr could be specified as an absolute path or ..//ffoooo::bbaarr to avoid
       ...
       When Git doesn’t know how to handle a certain transport protocol, it attempts
       to use the _r_e_m_o_t_e_-_<_t_r_a_n_s_p_o_r_t_> remote helper, if one exists. To explicitly
       ...
       string recognized by the specific remote helper being invoked. See ggiittrreemmoottee--
...
RREEMMOOTTEESS
   ...
   NNaammeedd rreemmoottee iinn ccoonnffiigguurraattiioonn ffiillee
       ...
       configured using ggiitt--rreemmoottee(1), ggiitt--ccoonnffiigg(1) or even by a manual edit to the
       $$GGIITT__DDIIRR//ccoonnffiigg file. The URL of this remote will be used to access the
   ...
   NNaammeedd ffiillee iinn $$GGIITT__DDIIRR//rreemmootteess
       You can choose to provide the name of a file in $$GGIITT__DDIIRR//rreemmootteess. The URL in
       ...
       PPuusshh:: lines are used by _g_i_t _p_u_s_h and PPuullll:: lines are used by _g_i_t _p_u_l_l and _g_i_t
       _f_e_t_c_h. Multiple PPuusshh:: and PPuullll:: lines may be specified for additional branch
       mappings.

   NNaammeedd ffiillee iinn $$GGIITT__DDIIRR//bbrraanncchheess
       You can choose to provide the name of a file in $$GGIITT__DDIIRR//bbrraanncchheess. The URL in
       ...
       don’t provide one on the command line. <<bbrraanncchh>> is the name of this file in
...
OOUUTTPPUUTT
       ...
       describes the output when pushing over the Git protocol (either locally or via
       ssh).
       ...
       summary
           ...
           the ref in a form suitable for using as an argument to ggiitt lloogg (this is
           <<oolldd>>....<<nneeww>> in most cases, and <<oolldd>>......<<nneeww>> for forced non-fast-forward
           updates).
           ...
           remote rejected
               ...
               safety options in effect: rreecceeiivvee..ddeennyyCCuurrrreennttBBrraanncchh (for pushes to the
               checked out branch), rreecceeiivvee..ddeennyyNNoonnFFaassttFFoorrwwaarrddss (for forced
       ...
       from
           The name of the local ref being pushed, minus its rreeffss//<<ttyyppee>>// prefix. In
...
NNOOTTEE AABBOOUUTT FFAASSTT--FFOORRWWAARRDDSS
       ...
       at A) with commit B. This does _n_o_t fast-forward. If you did so, the changes
       introduced by commit A will be lost, because everybody will now start building
       on top of B.

       The command by default does not allow an update that is not a fast-forward to
       prevent such loss of history.

       If you do not want to lose your work (history from X to B) or the work by the
       ...
       into a repository nobody else pushes into. After you push commit A yourself (in
       ...
       pushed A out already. In such a case, and only if you are certain that nobody
       in the meantime fetched your earlier commit A (and started building on top of
       it), you can run "git push --force" to overwrite it. In other words, "git push
       --force" is a method reserved for a case where you do mean to lose history.

EEXXAAMMPPLLEESS
       ggiitt ppuusshh
           Works like ggiitt ppuusshh <<rreemmoottee>>, where <remote> is the current branch’s remote
           (or oorriiggiinn, if no remote is configured for the current branch).

       ggiitt ppuusshh oorriiggiinn
           Without additional configuration, pushes the current branch to the
           configured upstream (bbrraanncchh..<<nnaammee>>..mmeerrggee configuration variable) if it has
           the same name as the current branch, and errors out without pushing
           otherwise.

           The default behavior of this command when no <refspec> is given can be
           configured by setting the ppuusshh option of the remote, or the ppuusshh..ddeeffaauulltt
           configuration variable.

           For example, to default to pushing only the current branch to oorriiggiinn use
           ggiitt ccoonnffiigg rreemmoottee..oorriiggiinn..ppuusshh HHEEAADD. Any valid <refspec> (like the ones in
           the examples below) can be configured as the default for ggiitt ppuusshh oorriiggiinn.

       ggiitt ppuusshh oorriiggiinn ::
           Push "matching" branches to oorriiggiinn. See <refspec> in the OPTIONS section
           above for a description of "matching" branches.

       ggiitt ppuusshh oorriiggiinn mmaasstteerr
           Find a ref that matches mmaasstteerr in the source repository (most likely, it
           would find rreeffss//hheeaaddss//mmaasstteerr), and update the same ref (e.g.
           rreeffss//hheeaaddss//mmaasstteerr) in oorriiggiinn repository with it. If mmaasstteerr did not exist
       ...
       ggiitt ppuusshh mmootthheerrsshhiipp mmaasstteerr::ssaatteelllliittee//mmaasstteerr ddeevv::ssaatteelllliittee//ddeevv
           Use the source ref that matches mmaasstteerr (e.g.  rreeffss//hheeaaddss//mmaasstteerr) to update
           the ref that matches ssaatteelllliittee//mmaasstteerr (most probably
           rreeffss//rreemmootteess//ssaatteelllliittee//mmaasstteerr) in the mmootthheerrsshhiipp repository; do the same
           ...
           This is to emulate ggiitt ffeettcchh run on the mmootthheerrsshhiipp using ggiitt ppuusshh that is
           run in the opposite direction in order to integrate the work done on
           ssaatteelllliittee, and is often necessary when you can only make connection in one
           ...
           After running this ggiitt ppuusshh on the ssaatteelllliittee machine, you would ssh into
           the mmootthheerrsshhiipp and run ggiitt mmeerrggee there to complete the emulation of ggiitt
       ...
       ggiitt ppuusshh oorriiggiinn mmaasstteerr::rreeffss//hheeaaddss//eexxppeerriimmeennttaall
           ...
           current mmaasstteerr branch. This form is only needed to create a new branch or
       ...
       ggiitt ppuusshh oorriiggiinn ++ddeevv::mmaasstteerr
           ...
           non-fast-forward updates.  TThhiiss ccaann lleeaavvee uunnrreeffeerreenncceedd ccoommmmiittss ddaanngglliinngg iinn
           tthhee oorriiggiinn rreeppoossiittoorryy..  Consider the following situation, where a
           ...
           and so would be unreachable. As such, these commits would be removed by a
...
SSEECCUURRIITTYY
       ...
       is to store it in another repository. This applies to both clients and servers.
       In particular, namespaces on a server are not effective for read access
       control; you should only grant read access to a namespace to clients that you
